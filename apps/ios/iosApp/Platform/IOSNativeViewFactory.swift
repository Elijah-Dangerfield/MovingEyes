...
final class IOSNativeViewFactory: MovingEyesNativeViewFactory {
    ...
    func createAppleSignInButton(
        kind: MovingEyesNativeAppleSignInButtonKind,
        style: MovingEyesNativeAppleSignInButtonStyle,
        cornerRadius: Float,
        onTap: @escaping () -> Void
    ) throws -> UIView {
...
private extension MovingEyesNativeAppleSignInButtonKind {
...
private extension MovingEyesNativeAppleSignInButtonStyle {
