...
class ConfigAdminRoutesTest {
    ...
    private fun testApp(
        ...
        notifier: com.dangerfield.movingeyes.server.domain.ConfigChangeNotifier =
            com.dangerfield.movingeyes.server.domain.ConfigChangeNotifier {},
    ...
    fun upsertFlag_notifiesOnSuccess() = runTest {
        ...
        val notifier = com.dangerfield.movingeyes.server.domain.ConfigChangeNotifier { notified = it.flagPath }
