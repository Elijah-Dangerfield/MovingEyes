...
import com.dangerfield.movingeyes.server.config.ObservabilityConfig
...
class TelemetryTest {
    ...
    fun buildOpenTelemetrySdk_resourceCarriesServiceAndEnvAttrs() {
        ...
        assertEquals("movingeyes-server", resourceAttrs.get(AttributeKey.stringKey("service.name")))
    ...
    companion object {
        ...
        private val sdk = buildOpenTelemetrySdk(
            ObservabilityConfig(
                otlpEndpoint = null,
                otlpHeaders = null,
                serviceName = "movingeyes-server-test",
                environment = "test",
                release = null,
            ),
            spanExporter = exporter,
