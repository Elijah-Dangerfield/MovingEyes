...
import com.dangerfield.movingeyes.features.settings.impl.feedback.FeedbackRepository
...
import movingeyes.libraries.resources.generated.resources.feedback_bug_sent
...
class BugReportViewModel(
    ...
    private suspend fun BugReportAction.submitBugReport() {
        ...
        repository.submitFeedback(
            ...
            showSnackBar(message = getString(Res.string.feedback_bug_sent), delayBy = 1.seconds)
            router.goBack()
        }
    }
}
