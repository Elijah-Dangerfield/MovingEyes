...
import com.dangerfield.movingeyes.libraries.ui.components.SummaryRow
...
import movingeyes.libraries.resources.generated.resources.feedback_bug_title
import movingeyes.libraries.resources.generated.resources.feedback_captured
import movingeyes.libraries.resources.generated.resources.feedback_error_code
import movingeyes.libraries.resources.generated.resources.feedback_report_id
import movingeyes.libraries.resources.generated.resources.feedback_bug_body
import movingeyes.libraries.resources.generated.resources.feedback_message
import movingeyes.libraries.resources.generated.resources.feedback_message_hint
...
fun BugReportScreen(
    ...
    Screen(
        ...
        topBar = {
            TopBar(
                title = stringResource(Res.string.feedback_bug_title),
        ...
        Column(
            ...
            if (state.hasContext) {
                SectionCard(title = stringResource(Res.string.feedback_captured)) {
                    ...
                    state.errorCode?.let {
                        SummaryRow(
                            label = stringResource(Res.string.feedback_error_code),
                            value = "$it"
                        )
                    }
                    ...
                    state.logId?.let {
                        SummaryRow(
                            label = stringResource(Res.string.feedback_report_id),
                            value = it
                        )
                    }
                }
            ...
            Text(
                text = stringResource(Res.string.feedback_bug_body),
