 ...
 * `MovingEyesBuildConfig` (see `loadTelemetryMetadata` in build-logic): CI reads
...
internal object GrafanaCloud {
    val OTLP_BASE_URL: String = MovingEyesBuildConfig.GRAFANA_OTLP_BASE_URL
    val INSTANCE_ID: String = MovingEyesBuildConfig.GRAFANA_OTLP_INSTANCE_ID
    val LOGS_WRITE_TOKEN: String = MovingEyesBuildConfig.GRAFANA_LOGS_WRITE_TOKEN
