...
import com.dangerfield.movingeyes.libraries.core.buildType
...
import com.dangerfield.movingeyes.libraries.core.logging.Logger
import com.dangerfield.movingeyes.libraries.movingeyes.Telemetry
import com.dangerfield.movingeyes.libraries.movingeyes.impl.logging.DevConsoleWriter
import com.dangerfield.movingeyes.libraries.movingeyes.impl.logging.KermitLogTree
import com.dangerfield.movingeyes.libraries.movingeyes.impl.logging.SentryLogTree
...
data class SentryRuntimeConfig(
    ...
    companion object {
        fun forApp(buildInfo: BuildInfo): SentryRuntimeConfig {
            ...
            // string match.
            val release = "movingeyes@${buildInfo.versionName}+${buildInfo.buildNumber}"
