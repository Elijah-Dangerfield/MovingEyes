...
import com.dangerfield.movingeyes.libraries.ui.components.dialog.ModalContent
...
import com.dangerfield.movingeyes.system.VerticalSpacerD800
...
private fun PreviewBasicBottomSheet() {
    PreviewContent {
        com.dangerfield.movingeyes.libraries.ui.components.dialog.bottomsheet.BasicBottomSheet(
            state = rememberBottomSheetState(BottomSheetValue.Expanded),
            onDismissRequest = { -> },
            modifier = Modifier,
            stickyTopContent = { Text(text = "Top Content") },
