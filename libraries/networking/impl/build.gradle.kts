...
android {
    namespace = "com.dangerfield.movingeyes.libraries.networking.impl"
}
...
// local iOS dev builds — pass `-Pmovingeyes.wiretap.ios=false` to link the
// zero-overhead noop instead.
//
// Store builds flip it via the MOVING_EYES_WIRETAP_IOS env var (set by the
...
val wiretapIosEnabled =
    (providers.environmentVariable("MOVING_EYES_WIRETAP_IOS").orNull
        ?: providers.gradleProperty("movingeyes.wiretap.ios").orNull
        ?: "true").toBoolean()
